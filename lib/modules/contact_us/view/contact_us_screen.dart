import 'package:e_shop/modules/contact_us/model/developer_links_model.dart';
...
import 'package:e_shop/modules/contact_us/model/developer_basic_info_model.dart';
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  ...DeveloperLinksData.getDeveloperLinks.map((e) =>  IconButton(
                    icon: Tooltip(
                      message: e.name,
                      child: Icon(
                        e.icon,
...
class _DeveloperInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        ...DeveloperInfoData.getInfo.map((e) =>  FlippingCard(
