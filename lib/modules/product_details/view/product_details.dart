    ...
    return BlocConsumer<HomeCubit, HomeStates>(
      listener: (context, state) {
        if (state is RateProductState)
          DefaultDialogue.showSnackBar(context, 'Thanks for your feedback',
              labelColor: isDark ? Colors.white : Colors.black, dialogueStates: DialogueStates.NONE, isDark: isDark);
      },
           ...
           MyConditionalBuilder(
             ...
             onBuild:SizedBox(
               ...
               child: OutlinedButton(
                 child: LottieBuilder.asset(kLikeLottie,repeat: false,fit: BoxFit.cover,),
             ...
             onError:  SizedBox(
               ...
               //liked or unliked
               child: OutlinedButton(
                 child: cubit.favourites?[product?.id] == true? Icon(Icons.favorite,color:kLikeButtonColor,) : Icon(Icons.favorite_outline),
                 onPressed: () => cubit.changeFavourites(product!.id!),
               ),
             ),
           );
                    ...
                    child: PageView.builder(
                        ...
                        itemBuilder: (context,index){
                          return  MyConditionalBuilder
                            ...
                            onError: Hero(tag: '$productID ', child: kHashImage,
                            ),);
                        }),
                  ) ,
